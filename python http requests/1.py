...
post_response = requests.post('https://losoviny.iamroot.eu/part_one_login', data=data)
print(post_response)
...
get_response = requests.get("https://losoviny.iamroot.eu/part_one", headers=header)
print(get_response)
